(function(a, b) {
    ...
    function ai(a) {
        ...
        return {
            height: ay("Height", d, c, b),
            width: ay("Width", d, c, b)
        }
    }
    ...
    function a8(g) {
        ...
        var r = {
            ...
            c = v.width || g.clientWidth || r.right - r.left,
            b = v.height || g.clientHeight || r.bottom - r.top,
            j = g.offsetWidth - c,
            k = g.offsetHeight - b;
        if (j || k) {
            var x = w(g);
    ...
    function bb(b, y, n, w) {
        var v = 4 < arguments.length && void 0 !== arguments[4] && arguments[4],
            x = {
                top: 0,
                left: 0
            },
    ...
    function aM(a, g, c, b) {
        ...
        d.addEventListener(g, c, {
            passive: !0
        }), f || aM(aO(d.parentNode), g, c, b), b.push(d)
    }

    function at(a, f, c, b) {
        c.updateBound = b, ad(a).addEventListener("resize", c.updateBound, {
            passive: !0
        });
        var d = aO(a);
    ...
    function aE(a, b) {
        Object.keys(b).forEach(function(d) {
            var c = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(d) && bi(b[d]) && (c = "px"), a.style[d] = b[d] + c
        })
    }
    ...
    var aB = a7 && window.Promise,
        ...
        a4 = a7 && /MSIE 10/.test(navigator.userAgent),
        an = function(a, b) {
            if (!(a instanceof b)) {
        ...
        modifiers: {
            ...
            hide: {
                ...
                fn: function(a) {
                    ...
                    var c = a.offsets.reference,
                        b = aj(a.instance.modifiers, function(d) {
            ...
            computeStyle: {
                ...
                fn: function(u, J) {
                    var G = J.x,
                        F = J.y,
                        B = u.offsets.popper,
                        H = aj(u.instance.modifiers, function(a) {
                    ...
                    var I, q, j = void 0 === H ? J.gpuAcceleration : H,
                        C = aU(u.instance.popper),
                        x = a8(C),
                        D = {
                            position: B.position
                        },
                        A = aX(u, 2 > window.devicePixelRatio || !aN),
            ...
            applyStyle: {
                ...
                onLoad: function(a, h, d, c, b) {
                    ...
                    return h.setAttribute("x-placement", f), aE(h, {
                        position: d.positionFixed ? "fixed" : "absolute"
                    }), d
                },
